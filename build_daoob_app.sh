...
class EventCategory {
  ...
  // Get translated names in Arabic
  static Map<String, String> getArabicNames() {
    return {
      'Wedding': 'زفاف',
      'Corporate': 'شركات',
      'Birthday': 'عيد ميلاد',
...
# Create booking service for offline caching
cat > lib/services/booking_service.dart << 'EOL'
import 'dart:convert';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:daoob_mobile/services/auth_service.dart';
